...
const Select = React.forwardRef(({ value, defaultValue, onValueChange, ...props }: React.ComponentPropsWithoutRef<typeof SelectPrimitive.Root>, _ref: any) => {
  ...
  return (
    <SelectPrimitive.Root
      {...props}
      //ref={ref} // SelectPrimitive.Root might not accept a ref directly or types are mismatching
      value={internalValue}
